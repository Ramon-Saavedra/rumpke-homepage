...
# Dependabot PRs: Manual Approval Required

Automatic dependency updates generated by Dependabot create pull requests (PRs) in this repository.

- Due to GitHub security policies, automatic PR approval via GitHub Actions is disabled.
- Every Dependabot PR must be manually reviewed and approved by a user with write or admin permissions.
- Once reviewed, you can approve and merge the PR into the main branch following the standard GitHub workflow.

This ensures compliance with best security and quality control practices for the project.

---

© Rumpke Immobilien, 2026. All rights reserved.
# Rumpke Immobilien
