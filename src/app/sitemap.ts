...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    {
      url: `${BASE_URL}/dienstleistungen`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/dienstleistungen/immobilien-kauf`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: `${BASE_URL}/dienstleistungen/verkauf-vermietung`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: `${BASE_URL}/dienstleistungen/immobilienbewertung`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.7,
    },
