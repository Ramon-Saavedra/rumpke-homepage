...
export const MOCK_FEATURED_PROPERTIES: FeaturedProperty[] = [
  ...
  },
  {
    ...
    imageUrl: '/imgs/property-6.jpg',
    slug: 'moderne-eigentumswohnung',
    area: '95 m²',
    rooms: 3,
    operationType: 'kauf',
  },
  {
    id: '7',
    title: 'Geräumiges Einfamilienhaus',
    type: 'Einfamilienhaus',
    price: '€ 920.000',
    location: 'Würzburg, Bayern',
    imageUrl: '/imgs/property-7.jpg',
    slug: 'geraeumiges-einfamilienhaus',
    area: '240 m²',
    rooms: 6,
    operationType: 'kauf',
  },
  {
    id: '8',
    title: 'Stilvolles Reihenhaus',
    type: 'Reihenhaus',
    price: '€ 3.200 / Monat',
    location: 'Erlangen, Bayern',
    imageUrl: '/imgs/property-8.jpg',
    slug: 'stilvolles-reihenhaus',
    area: '165 m²',
    rooms: 4,
    operationType: 'miete',
  },
  {
    id: '9',
    title: 'Exklusives Architektenhaus',
    type: 'Architektenhaus',
    price: '€ 1.480.000',
    location: 'Bamberg, Bayern',
    imageUrl: '/imgs/property-9.jpg',
    slug: 'exklusives-architektenhaus',
    area: '310 m²',
    rooms: 5,
    operationType: 'kauf',
  },
