...
describe("WhyChooseRumpke", () => {
  describe("Rendering", () => {
    ...
    it("renders intro paragraph", () => {
      render(<WhyChooseRumpke />);
      expect(
        screen.getByText(/Wir verbinden persönliche Nähe/),
      ).toBeInTheDocument();
    });
  });
  ...
  describe("Feature Items", () => {
    ...
    it("renders all three feature descriptions", () => {
      ...
      expect(
        screen.getByText(/regionalen Immobilienmarkt/),
      ).toBeInTheDocument();
  ...
  describe("Layout", () => {
    it("section has padding classes", () => {
      ...
      expect(section).toHaveClass("mb-24", "py-12");
    });
