...
const mockProperties = [
  { id: '1', slug: 'haus-1', title: 'Haus 1', type: 'Haus', price: '200.000 €', location: 'Bawinkel', imageUrl: '/img/1.jpg' },
  { id: '2', slug: 'haus-2', title: 'Haus 2', type: 'Wohnung', price: '150.000 €', location: 'Lingen', imageUrl: '/img/2.jpg' },
];

describe('TripleSlider', () => {
  it('renders section heading', () => {
    render(<TripleSlider properties={mockProperties} />);
    expect(screen.getByRole('heading', { name: /ausgewählte immobilien/i })).toBeInTheDocument();
  });
