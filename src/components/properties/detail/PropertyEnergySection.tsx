...
export default function PropertyEnergySection({
  ...
  return (
    <PropertyDetailSection title="Energieausweis">
      <div className="flex flex-wrap items-center gap-6 border border-border-l bg-bgSecondary-l p-6 dark:border-border-d dark:bg-bgSecondary-d">
        <span className="flex h-14 w-14 shrink-0 items-center justify-center bg-primary/10 text-primary">
