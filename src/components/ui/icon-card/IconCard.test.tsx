...
describe("IconCard", () => {
  describe("Rendering", () => {
    ...
    it("renders description text", () => {
      ...
      expect(
        screen.getByText("This is a detailed description of the card content"),
      ).toBeInTheDocument();
    });
  ...
  describe("Props", () => {
    it("accepts and renders custom icon", () => {
      const customIcon = (
        <svg data-testid="custom-icon" aria-label="Custom Icon" />
      );
      render(
        <IconCard icon={customIcon} title="Title" text="Text" link="/link" />,
      );
