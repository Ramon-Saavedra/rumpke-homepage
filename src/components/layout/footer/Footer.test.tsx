...
describe("Footer", () => {
  ...
  describe("Contact info", () => {
    ...
    it("renders email link", () => {
      ...
      const mail = screen.getByRole("link", {
        name: "info@rumpke-immobilien.de",
      });
    ...
    it("renders location icon", () => {
      render(<Footer />);
      expect(
        document.querySelector('[data-testid="location-icon"]'),
      ).toBeInTheDocument();
    });
    ...
    it("renders call icon", () => {
      render(<Footer />);
      expect(
        document.querySelector('[data-testid="call-icon"]'),
      ).toBeInTheDocument();
    });
  ...
  describe("Mieten section", () => {
    ...
    it("renders /miete link", () => {
      render(<Footer />);
      expect(
        screen.getByRole("link", { name: "Alle Mietimmobilien" }),
  ...
  describe("Dienstleistungen section", () => {
    ...
    it("renders /dienstleistungen link", () => {
      render(<Footer />);
      expect(
        screen.getByRole("link", { name: "Alle Dienstleistungen" }),
    ...
    it("renders /dienstleistungen/immobilien-kauf link", () => {
      render(<Footer />);
      expect(
        screen.getByRole("link", { name: "Immobilien Kauf" }),
    ...
    it("renders Verkauf & Vermietung link", () => {
      render(<Footer />);
      expect(
        screen.getByRole("link", { name: "Verkauf & Vermietung" }),
    ...
    it("renders /dienstleistungen/immobilienbewertung link", () => {
      render(<Footer />);
      expect(
        screen.getByRole("link", { name: "Immobilienbewertung" }),
      ).toHaveAttribute("href", "/dienstleistungen/immobilienbewertung");
    });
  });
